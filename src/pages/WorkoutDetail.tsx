...
import {
  expandSetForExercise, materializeLegacyDirections,
                    ...
                    <div className="space-y-3 py-2">
                      {selectedExercises.map((selectedEx, exIndex) => (
                        <SelectedExerciseCard
                          ...
                          dragHandleProps={touchReorder.bind(selectedEx.occurrenceId)}
                          ...
                          onShowInstructions={() => setInstructionsExercise(selectedEx.exercise)}
