...
export const exerciseList: Exercise[] = [
  ...
  },
  {
    ...
    imageUrl: 'private-exercise:push-up.jpg'
  },
  {
    id: '6',
    name: 'Running',
  ...
  },
  {
    ...
    imageUrl: 'private-exercise:standing-quad-stretch.jpg'
  },
  {
    id: '28',
  ...
  },
  {
    ...
    aliases: ['Side Leg Raise', 'Side-Lying Hip Abduction'],
    category: 'strength',
    ...
    secondsPerRep: 4,
    executionDirections: ['left', 'right'],
    instructions: 'Lie on one side with your legs straight and stacked, your head supported and your body forming one long line. Brace your core and keep your hips stacked as you lift the top leg without rolling backward; keep the knee straight and toes facing forward. Pause briefly, then lower with control without resting the leg completely. Use your top hand on the floor for balance and reduce the range if your pelvis begins to move.',
  ...
  {
    id: 'mobility-elephant-walks',
    name: 'Elephant Walks',
    aliases: ['Alternating Hamstring Walk'],
    category: 'flexibility',
    muscleGroups: ['Hamstrings', 'Calves', 'Hips'],
    ...
    defaultReps: 13,
    secondsPerRep: 4,
    instructions: 'Stand with both feet parallel, heels in line and directly beneath your hips. Hinge forward with a long spine and rest your hands on a sturdy chair or stool. Bend one knee while gently straightening the other leg to lengthen its hamstring, then switch sides smoothly. Keep both heels grounded and count one left-and-right cycle as one repetition.',
    imageUrl: 'private-exercise:mobility-elephant-walks.jpg'
  },
  {
    id: 'mobility-lying-cross',
    name: 'Lying Cross',
    aliases: ['Prone Cross-Body Shoulder Stretch'],
    category: 'flexibility',
    ...
    defaultDuration: 30,
    executionDirections: ['left', 'right'],
    instructions: 'Lie face-down and slide one arm straight across your chest at shoulder height with the palm resting on the floor. Keep that shoulder relaxed as you place the other hand near your face for light support and gently settle your chest toward the mat. Turn your head to a comfortable side, breathe steadily and stop if you feel pinching or numbness.',
    imageUrl: 'private-exercise:mobility-lying-cross.jpg'
  },
  {
    id: 'mobility-spine-backbend',
    name: 'Spine Backbend',
    aliases: ['Standing Spine Extension'],
    category: 'flexibility',
    ...
    defaultSets: 2,
    defaultDuration: 30,
    instructions: 'Stand tall with your feet parallel and about hip-width apart. Place both hands against your upper back with your elbows beside your ears, lift through your breastbone and gently extend through the upper and middle spine. Keep your hips over your feet, lightly engage your glutes and abdominals, and avoid collapsing into the lower back or forcing your neck.',
    imageUrl: 'private-exercise:mobility-spine-backbend.jpg'
  },
  {
    id: 'mobility-shoulder-backbend',
    name: 'Shoulder Backbend',
    aliases: ['Standing Overhead Backbend'],
    category: 'flexibility',
    muscleGroups: ['Shoulders', 'Back', 'Core'],
    equipment: ['Bodyweight'],
    difficulty: 'intermediate',
    ...
    defaultSets: 2,
    defaultDuration: 30,
    instructions: 'Stand with your feet parallel and ribs stacked over your pelvis. Reach both straight arms overhead with your palms facing inward, lengthen upward and then allow a small controlled extension through your upper back. Keep your arms close to your ears, hips centered above your feet and lower abdomen gently active; use a smaller range if your lower back compresses.',
    imageUrl: 'private-exercise:mobility-shoulder-backbend.jpg'
  },
  {
    id: 'mobility-rear-hand-clasp',
    ...
    defaultDuration: 30,
    executionDirections: ['left', 'right'],
    instructions: 'Stand tall and hold a strap in one hand. Reach that arm overhead, bend the elbow and let the strap hang behind your back; bring the other hand behind your waist to grasp the strap from below. Walk the hands toward each other only until you feel a gentle shoulder and triceps stretch, keeping your head upright, ribs controlled and both shoulders away from your ears.',
    imageUrl: 'private-exercise:mobility-rear-hand-clasp.jpg'
  },
  {
    id: 'mobility-wall-angels',
    name: 'Wall Angels',
    aliases: ['Wall Slides'],
    category: 'flexibility',
    ...
    defaultReps: 13,
    secondsPerRep: 5,
    instructions: 'Stand with your back against a wall, feet slightly forward and knees soft. Keep your ribs gently down as you place your arms against the wall in a goalpost shape, then slide them overhead only as far as you can without shrugging, arching your lower back or forcing contact. Lower slowly to the start and keep the movement smooth and pain-free.',
    imageUrl: 'private-exercise:mobility-wall-angel.jpg'
  },
  {
    id: 'mobility-towel-shoulder-pass-through',
    name: 'Towel Shoulder Pass-Through',
    aliases: ['Shoulder Dislocates', 'Belt Shoulder Pass-Through'],
    category: 'flexibility',
    muscleGroups: ['Shoulders', 'Chest', 'Back'],
    equipment: ['Strap'],
    difficulty: 'beginner',
    ...
    defaultReps: 13,
    secondsPerRep: 5,
    instructions: 'Stand tall and hold a towel or strap with a very wide overhand grip and straight elbows. Slowly raise it from your thighs, pass it overhead and continue behind you only through a comfortable range, then reverse the path to the start. Keep your ribs down and shoulders relaxed; widen your grip immediately if your elbows bend or either shoulder pinches.',
    imageUrl: 'private-exercise:mobility-belt-pole-chest-stretch-v3-palms-forward.jpg'
  }
];
